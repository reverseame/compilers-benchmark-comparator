...
OPT_LEVELS=("-O0" "-O1" "-O2" "-O3" "-Ofast" "-Os" "-Oz")

# Opciones de seguridad (una de cada categoría) específicas para clang++
SECURITY_OPTIONS=(
    ""                           # Sin protecciones
    "-fstack-protector"          # Protección básica contra desbordamiento de pila
    "-fstack-protector-strong"   # Protección fuerte contra desbordamiento de pila
    "-fstack-protector-all"      # Protección total contra desbordamiento de pila
    "-fno-stack-protector"       # Desactiva la protección contra desbordamiento de pila
    "-pie -fPIE"                 # Ejecutable independiente de posición
    ...
    "-D_FORTIFY_SOURCE=0"        # Fortificación desactivada
    "-z noexecstack"             # Pila no ejecutable
    "-Wl,-z,execstack"           # Pila ejecutable
    "-fno-plt"                   # Desactiva PLT
    "-fsanitize=address"         # AddressSanitizer
    "-fsanitize=undefined"       # Undefined Behavior Sanitizer
    "-Wl,-z,relro,-z,now"        # Full RELRO
    "-flto"                      # Link-Time Optimization (específico de Clang)
    "-fsanitize=safe-stack"      # Protección de pila segura (específico de Clang)
    "-fsanitize=memory"          # MemorySanitizer (específico de Clang)
)
